const addbtn=document.getElementById("btnin");
const todotask=document.getElementById('todotask');
const todolist=document.getElementById('todolist');
const paginztion=document.getElementById('paginztion');

const todos = []; 
const itemsPerPage = 3; // Number of tasks each  page
let currentPage = 1;
